...
// /movies - все фильмы. Фильтры по жанрам, странам, кол-ву оценок (можно задавать от и до), рейтингу. Сортировка по названию RU/EN, дате выхода, Максимальное количество возвращаемых фильмов может быть около 100
