        ...
        <div className={styles.wrapper} data-testid="film-all-devices">
            <div className={styles.info}>
                ...
                <div className={styles.info__button}>
                    <Button href={'https://www.ivi.ru/devices'} type="allDevices" label={t('buttonLabel')} />
                </div>
            </div>
            <div className={styles.image}>
                <Image
                    loader={() => 'https://www.ivi.ru/images/_ds/watchAllDevices/tv-without-poster.png'}
                    src={src}
                ...
                />
                <Image
                    loader={() => 'https://www.ivi.ru/images/_ds/watchAllDevices/ipad-without-poster.png'}
                    src={src}
                    alt="Устройства для просмотра Иви"
                    width={200}
                    height={136}
                ...
                />
                <Image src={src} alt="Постер" width={337} height={192} className={styles.image__tvPoster} />
                <Image src={src} alt="Постер" width={188} height={102} className={styles.image__tabletPoster} />
            </div>
        </div>
    )
}
